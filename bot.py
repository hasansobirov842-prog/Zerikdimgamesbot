...
def init_db():
    ...
    # =====================================================
    # USERS - ESKI MA'LUMOTLAR SAQLANADI
    # =====================================================
...
async def callbacks(update, context):
    ...
    if data.startswith("payment_approve:"):
        ...
        if amount < MIN_TOPUP:
            ...
            await query.answer(
                "Noto‘g‘ri to‘lov summasi.",
                show_alert=True
            )
            return

        # TO‘LOVNI BIR MARTA TASDIQLASH
        cur = conn.execute("""
